...
public class PentagonCrazy {
	...
	public static void main(String[] args) {
		...
		johnCena.setPenWidth(1);
		System.out.println("x: " + johnCena.getX() + ", y: " + johnCena.getY());
		johnCena.moveTo(1000, 500);
		//johnCena.moveTo(, angle);
