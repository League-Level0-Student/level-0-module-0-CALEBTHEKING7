...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if (dragonHealth <= 0 ) {
				...
				// 		dragon have left.
			JOptionPane.showMessageDialog(null,"Dragon health "+ dragonHealth + " Your health" + playerHealth);
	...
	static void playerLost() {
		...
		JOptionPane.showMessageDialog(null,"Work on your fighting skills,you lost.");
	...
	static void dragonLost() {
		...
		JOptionPane.showMessageDialog(null,"You win, you get gold.");
		System.exit(0);   //This code ends the program
	}
