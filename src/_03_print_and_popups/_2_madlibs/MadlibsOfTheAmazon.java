...
public class MadlibsOfTheAmazon{ 
	...
	public static void main(String[] args) {
		...
		//bodypart = JOptionPane.showInputDialog("What is a body verb");
		...
		String verb = JOptionPane.showInputDialog("What is a verb");
		// Get the player to enter a place
		String place = JOptionPane.showInputDialog("What is a place");
		...
		"day. Piranhas are attracted to fresh " + liquid + 
		" they are likely take a bite out of your " + bodypart +" if you " + verb + ". Whatever\n"  +
